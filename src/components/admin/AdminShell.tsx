...
const DEMO_NOTIFS = [
  {
    id: 1,
    title: 'Mollie webhook gefaald',
    message: 'tr_abc123 — handmatig opnieuw proberen',
    time: '2 min geleden',
    dot: 'bg-rose-500',
  },
  {
    id: 2,
    title: 'Nieuwe kraanafspraak',
    message: 'Jan Jansen · Aquila 8.90m',
    time: '12 min geleden',
    dot: 'bg-marine-500',
  },
  {
    id: 3,
    title: 'Stalling verloopt',
    message: 'Atalanta · over 9 dagen',
    time: '1 uur geleden',
    dot: 'bg-amber-500',
  },
];
