...
import { ArrowLeft, Fingerprint, MapPin, Share2, ShieldCheck } from 'lucide-react';
...
export default function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-navy-950">
      ...
      {/* Top utility bar */}
      <div className="relative z-10 flex h-16 items-center justify-between px-5 sm:px-8">
        <Link
          href={`/${locale}`}
...
function AuthTopTabs() {
  ...
  // Top tabs: Create Account  |  Sign In (NauticSecure pattern)
  return (
